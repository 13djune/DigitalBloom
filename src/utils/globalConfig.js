...
export const tagList = [
  ...
  { name: "Liked", type: "state" }, { name: "Saved", type: "state" }, { name: "Following", type: "state" }, { name: "Spam", type: "state" },
  ...
  { name: "Cuerpo", type: "nivel" },  { name: "Rastro", type: "nivel" },  { name: "Deseo", type: "nivel" },
];
